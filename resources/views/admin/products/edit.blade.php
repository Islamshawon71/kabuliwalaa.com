...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="regular_price">{{ trans('cruds.product.fields.regular_price') }}</label>
                <input class="form-control {{ $errors->has('regular_price') ? 'is-invalid' : '' }}" type="number" name="regular_price" id="regular_price" value="{{ old('regular_price', $product->regular_price) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sale_price') ? 'is-invalid' : '' }}" type="text" name="sale_price" id="sale_price" value="{{ old('sale_price', $product->sale_price) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('priority') ? 'is-invalid' : '' }}" type="text" name="priority" id="priority" value="{{ old('priority', $product->priority) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('seo_content') ? 'is-invalid' : '' }}" name="seo_content" id="seo_content">{{ old('seo_content', $product->seo_content) }}</textarea>
