    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wpid') ? 'is-invalid' : '' }}" type="text" name="wpid" id="wpid" value="{{ old('wpid', '') }}">
                @if($errors->has('wpid'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('memo') ? 'is-invalid' : '' }}" type="text" name="memo" id="memo" value="{{ old('memo', '') }}">
                @if($errors->has('memo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery') ? 'is-invalid' : '' }}" type="number" name="delivery" id="delivery" value="{{ old('delivery', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('discount_type') ? 'is-invalid' : '' }}" name="discount_type" id="discount_type">
                    ...
                    @foreach(App\Models\Order::DISCOUNT_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('discount_type', 'Price') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('confirm_date') ? 'is-invalid' : '' }}" type="text" name="confirm_date" id="confirm_date" value="{{ old('confirm_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('complete_date') ? 'is-invalid' : '' }}" type="text" name="complete_date" id="complete_date" value="{{ old('complete_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', 'Processing') }}" required>
