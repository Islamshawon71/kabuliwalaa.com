        ...
        <form method="POST" action="{{ route("admin.couriers.update", [$courier->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('city_available') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="city_available" id="city_available" value="1" {{ $courier->city_available || old('city_available', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('zone_available') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="zone_available" id="zone_available" value="1" {{ $courier->zone_available || old('zone_available', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_charge') ? 'is-invalid' : '' }}" type="text" name="delivery_charge" id="delivery_charge" value="{{ old('delivery_charge', $courier->delivery_charge) }}">
