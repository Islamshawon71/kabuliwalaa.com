    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.order-payments.update", [$orderPayment->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="text" name="amount" id="amount" value="{{ old('amount', $orderPayment->amount) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transaction_number') ? 'is-invalid' : '' }}" type="text" name="transaction_number" id="transaction_number" value="{{ old('transaction_number', $orderPayment->transaction_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $orderPayment->date) }}" required>
                @if($errors->has('date'))
