...
class SupplierController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('supplier_phone', function ($row) {
                return $row->supplier_phone ? $row->supplier_phone : '';
            });
            $table->editColumn('status', function ($row) {
                return $row->status ? Supplier::STATUS_SELECT[$row->status] : '';
            });
    ...
    public function show(Supplier $supplier)
    {
        ...
        $supplier->load('supplierPurchases');
